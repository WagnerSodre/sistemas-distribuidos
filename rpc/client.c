...
/* função que chama a RPC mtp_1 */
int mtp (CLIENT *clnt, int x, int y)
{
   operands ops;
   int *result;
...
/* função que chama a RPC dvs_1 */
int dvs (CLIENT *clnt, int x, int y)
{
   operands ops;
   int *result;
